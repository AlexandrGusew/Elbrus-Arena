...
export class RoundActionsDto {
  ...
  @IsIn(VALID_ZONES, { each: true, message: 'Неверная зона атаки. Допустимые: head, body, legs, arms' })
  attacks: Zone[];
  ...
  @IsIn(VALID_ZONES, { each: true, message: 'Неверная зона защиты. Допустимые: head, body, legs, arms' })
